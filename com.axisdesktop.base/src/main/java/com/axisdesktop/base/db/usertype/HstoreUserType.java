package com.axisdesktop.base.db.usertype;
...
/**
 * Custom Hibernate {@link UserType} used to convert between a {@link Map} and PostgreSQL {@code hstore} data type.
 */
public class HstoreUserType implements UserType {
	 ...
	 */
	private static final Pattern HSTORE_ENTRY_PATTERN = Pattern
			.compile( String.format( "\"(.*)\"%s\"(.*)\"", HSTORE_SEPARATOR_TOKEN ) );
